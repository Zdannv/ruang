...
export const metadata: Metadata = { title: "Pesan · Ada Tempat" };
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 pb-16 pt-8 sm:px-6 lg:px-8">
      ...
      <p className="mt-1.5 text-sm text-muted">
        Tanya-jawab dengan pemilik lahan. Satu utas per lahan, dan isinya tidak
        bisa dihapus atau diubah setelah terkirim.
      </p>
