...
2. SQL Editor → jalankan berurutan: `01_schema.sql`, `03_auth_rls.sql`,
   ...
   `19_rubrik_usaha.sql`, `20_verifikasi.sql`, `21_alamat_terbuka.sql`, `22_statistik.sql`.
   **Semuanya wajib.** Aplikasi membaca lewat view yang dibuat di `03`–`05`
   ...
   `20` menambahkan verifikasi lahan beserta peran adminnya. **Layarnya
   sudah dibuang** 18 September 2026 karena belum ada karyawan lapangan yang
   bisa datang memeriksa; migrasinya tetap dijalankan supaya urutannya utuh,
   dan tabelnya menunggu di tempat kalau nanti dipakai lagi.
